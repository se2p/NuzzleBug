        ...
        if (explanationState === EXPLANATION_STATE.INTRO) {
            return (
                <span>
                    ...
                    <div
                        className={css.closeHelpButton}
                        onClick={() => setExplanationState(EXPLANATION_STATE.EXPLANATION)}
                    >
        ...
        if (explanationState === EXPLANATION_STATE.EXPLANATION) {
            return (
                <span>
                    ...
                    <div
                        className={css.closeHelpButton}
                        onClick={() => setExplanationState(EXPLANATION_STATE.NONE)}
                    >
        ...
        <div className={css.container}>
            <h1 className={css.header}>
                {tutorialConfig.selection.enableTutorialSelectionHelp && explanationState === EXPLANATION_STATE.NONE &&
                    <div
                        className={css.help}
                        onClick={() => setExplanationState(EXPLANATION_STATE.INTRO)}
                    >
                        <span>?</span>
            ...
            <div
                className={css.tutorialCardContainer}
                style={{
