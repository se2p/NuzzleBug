...
const DebuggingTutorialStep = props => {
        ...
        switch (curPage) {
            ...
            case PAGE_RESPONSE:
                return <ResponsePage
                    ...
                    onClickTest={() => {setCurPage(PAGE_TEST_RESULTS); onStartTests()}}
                />;
    ...
    return <>
        ...
        {curPage === PAGE_TEST_RESULTS && <div className={css.leftButton} onClick={() => {if (isDebuggingTutorial) {setCurPage(PAGE_RESPONSE);} else {setCurPage(PAGE_OVERVIEW);} if (testResults?.passed) {setResponseType(RESPONSE_TESTING_FINISHED)} else {setResponseType(RESPONSE_DEFAULT)}}}>
            <img src={leftArrow} alt="Next" draggable={false} />
        </div>}
        {curPage === PAGE_HELP && <div className={css.leftButton} onClick={() => {setCurPage(PAGE_TEST_RESULTS)}}>
            <img src={leftArrow} alt="Next" draggable={false} />
        </div>}
        {renderPage()}
    </>
