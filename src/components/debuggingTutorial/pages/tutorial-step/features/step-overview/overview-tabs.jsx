        ...
        <div className={css.tabContainer}>
            ...
            >
                <div style={{ display: "flex", alignItems: "center" }}>
                    <img className={css.icon} src={iconDescription} alt="icon" draggable={false} />
            ...
            {isDebuggingTutorial && (
                ...
                >
                    <div style={{ display: "flex", alignItems: "center" }}>
                        <img className={css.icon} src={iconErrors} alt="icon" draggable={false} />
            ...
            {showControlOverview && (
                ...
                >
                    <div style={{ display: "flex", alignItems: "center" }}>
                        <img className={css.icon} src={iconControls} alt="icon" draggable={false} />
