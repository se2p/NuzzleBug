...
class PostDominatedTree extends Graph {
}
 ...
 * @returns {PostDominatedTree} - the constructed dominance tree.
 * @private
 */
const _buildDominanceTree = (cfg, dominanceMap) => {
    const dominanceTree = new PostDominatedTree(cfg.entry());
    const allNodes = new Set(cfg.getAllNodes());
 ...
 * @returns {PostDominatedTree} - the generated post dominated tree.
 */
