import {Edge, Graph, GraphNode, reverseGraph} from './graph-utils';
import {computePostDominatedTree, PostDominatedTree} from './post-dominator-tree'; // eslint-disable-line no-unused-vars
 ...
 * @param {PostDominatedTree} reversedPDT - the reversed PDT, to find ancestors easier.
 ...
 *
 * @param {PostDominatedTree} postDominatedTree - the PDT used to extract the information.
 ...
 * @param {PostDominatedTree} postDominatedTree - the PDT.
 * @param {PostDominatedTree} reversedPDT - the PDT, but reversed.
